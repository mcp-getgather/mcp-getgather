...
async def get_product_details(
    ...
    if await brand_state_manager.is_brand_connected(tokopedia_mcp.brand_id):
        profile_id = await brand_state_manager.get_browser_profile_id(tokopedia_mcp.brand_id)

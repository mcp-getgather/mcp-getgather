...
async def setup_proxy(
    ...
    if not settings.HTTP_PROXY or not settings.HTTP_PROXY_PASSWORD:
        logger.info("No proxy configured (HTTP_PROXY and HTTP_PROXY_PASSWORD not set)")
        return None
